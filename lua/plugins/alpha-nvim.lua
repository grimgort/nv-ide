...
local logo = {
	[[ _______ ______  _______ _____     _____ _____   _______ ]],
	[[ (_______|_____ \(_______|____ \   (_____|____ \ (_______) ]],
	[[  _____   _____) )_____   _   \ \ ___ _   _   \ \ _____    ]],
	[[ |  ___) (_____ (|  ___) | |   | (___) | | |   | |  ___)   ]],
	[[ | |           | | |_____| |__/ /   _| |_| |__/ /| |_____  ]],
	[[ |_|           |_|_______)_____/   (_____)_____/ |_______) ]],
}
...
local buttons = {
  ...
  val = {
    ...
    dashboard.button("s", "  NV-IDE config", ":e ~/AppData/Local/nvim/lua/plugins.lua<CR>"),
